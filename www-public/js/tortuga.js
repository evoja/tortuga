	...
	)
{
	...
	var tortoiseRunner = Tortuga.Vm.initVm(canvasObjects.canvas, canvasObjects.canvasContainer)
	Tortuga.initTortoise(canvasObjects.canvasContainer, tortoiseRunner)
